...
const MiniCssExtractPlugin    = require('mini-css-extract-plugin');  //uotros archivos de otro paquetes
const CopyPlugin        = require("copy-webpack-plugin");

const CssMinimizer      = require('css-minimizer-webpack-plugin'); //forma de importanciones en node.js
